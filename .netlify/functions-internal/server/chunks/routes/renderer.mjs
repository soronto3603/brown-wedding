...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#F2728A"}],"link":[{"rel":"icon","href":"/weddic-icon.svg","type":"image/svg+xml"},{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/dist/web/static/pretendard.min.css"}],"style":[],"script":[],"noscript":[],"title":"brown-wedding","htmlAttrs":{"lang":"ko"}};
